...
- When you need better prompts or AI workflows (Jeff Su-style TASK/CONTEXT/EXEMPLARS, XML tags, outcome-based prompting), switch to Prompt Lab and build the prompt there; then run the resulting commands or scripts here.
